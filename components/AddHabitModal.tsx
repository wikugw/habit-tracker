...
export default function AddHabitModal({ onCreated, onClose }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div className="relative w-full max-w-md bg-white dark:bg-zinc-900 rounded-t-3xl sm:rounded-3xl shadow-2xl p-6 pb-10 sm:pb-6 z-10 border border-transparent dark:border-zinc-800">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div>
            <label className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wide mb-2 block">Description <span className="text-zinc-400 font-normal">(optional)</span></label>
            <input
              type="text"
              value={description}
          ...
          <div>
            ...
            {frequency === 'weekly' && (
              <div className="mt-3">
                <label className="text-xs text-zinc-500 dark:text-zinc-400 mb-1 block">Target days per week: <strong className="text-zinc-800 dark:text-zinc-200">{targetDays}</strong></label>
